#source https://blog.flaport.net/yolo-part-1.html
...
def tinyyolov2(num_classes=10, pretrained=True):
    return TinyYoloV2(num_classes=num_classes)


if __name__ == '__main__':

    net = TinyYoloV2(num_classes=10)
    ...
    torchinfo.summary(net, (1, 3, 320, 320))

    torch.onnx.export(net, x, "tinyyolov2.onnx", export_params=True)
